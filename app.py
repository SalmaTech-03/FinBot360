...
# --- FIXED `create_lstm_model` FUNCTION ---
...
with st.sidebar:
    ...
    with st.expander("🔴 Live Market Dashboard"):
        ...
        try:
            ...
            st.error("Could not fetch live data. API limit may have been reached.")
        ...
        if uploaded_file:
            try:
                ...
                if 'Date' in df.columns and 'Close' in df.columns:
                    ...
                    st.plotly_chart(plot_portfolio_performance(df, cum_returns), use_container_width=True)
                else:
